...
Data *head, *tail, *cur, *newNode, *t;

class kereta{ 
	public:
		// materi 4 :: linked list single
		void createData(string tujuan);
		void tambahAkhir(string tujuan);
		void tambahAwal(string tujuan);
		void printData();
		...
		void cetak();
	private:
		int pil, tujuan, pilihan, pilharga, jumlah, penumpang, harga, saldo, tagpem, tagpem1, a, b;
...
void kereta::createData(string tujuan){
	head = new Data();
	head->tujuan = tujuan;	
	head->next= NULL;
	tail = head;
}
void kereta::tambahAwal(string tujuan){
	newNode = new Data();
	newNode->tujuan = tujuan;
	newNode->next= head;
	head = newNode;
}
void kereta::tambahAkhir(string tujuan){
	newNode = new Data();
	newNode->tujuan= tujuan;
	newNode->next= NULL;
	tail->next = newNode;
...
void kereta::printData(){
	cur = head;
	while( cur != NULL){
		cout << cur->tujuan<<endl;
		cur = cur->next;		
	}
}
void kereta::login(){
...
void kereta::tujuann(){
	cout << "====================================================" << endl;
  	...
  	cout << "====================================================" << endl;
	createData(" 2. Surabaya"); 	
	tambahAwal(" 1. Jakarta"); 
	tambahAkhir(" 3. Bandung");
	tambahAkhir(" 4. Yogyakarta");
	printData();
	cout << "====================================================" << endl;
...
void kereta::cetak(){
	...
	if(lanjut=="y"||lanjut=="Y"){
		...
		cin >> saldo;
		cout << " Kembalian : " << saldo-kereta::rekursif(pilharga, jumlah) << endl;
